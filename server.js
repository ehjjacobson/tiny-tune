...
const ensureAccessToken = async (req, res, next) => {
    try {
        await ensureDBConnection(req, res, next);
...
app.get('/callback', ensureDBConnection, async (req, res) => {
...
app.get('/widget', ensureDBConnection, (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'widget.html'));
});

// Logout endpoint
app.get('/logout', ensureDBConnection, async (req, res) => {
    try {
